...
// Home Route
Route::get('', ['as' => 'Home', 'uses' => 'WelcomeController@index', 'middleware' => 'home']);
...
Route::get('admin', ['as' => 'admin', 'uses' => 'AuthController@home']);

// Auth => login form
Route::get('admin/auth/login', ['as' => 'Auth.login', 'uses' => 'AuthController@showLoginForm']);

// Auth => process form data
Route::post('admin/auth/login', ['as' => 'Auth.login', 'uses' => 'AuthController@postLogin']);

// Auth => Logout
Route::get('admin/auth/logout', ['as' => 'Auth.logout', 'uses' => 'AuthController@getLogout']);
Route::post('admin/auth/logout', ['as' => 'Auth.logout', 'uses' => 'AuthController@getLogout']);

// Auth Denied. For Error Handling
BaseRoute::get('admin/auth/denied', ['as' => 'Auth.denied', 'uses' => 'AuthController@denied']);

// Core Admin API
BaseRoute::group([], function () {

    // Base routes for global search
    BaseRoute::get('base/fulltextSearch', ['as' => 'Base.fulltextSearch', 'uses' => 'BaseController@fulltextSearch']);
    ...
    BaseRoute::get('Config', ['as' => 'Config.index', 'uses' => 'GlobalConfigController@index']);
